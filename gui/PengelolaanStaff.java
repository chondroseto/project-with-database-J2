 ...
 * @author chondroseto
 */
public class PengelolaanStaff extends javax.swing.JFrame {

    /**
     * Creates new form PengelolaanStaff
     */
    public PengelolaanStaff() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PengelolaanStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PengelolaanStaff().setVisible(true);
            }
        });
    }
